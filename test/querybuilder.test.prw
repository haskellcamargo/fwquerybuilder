...
Feature _21_ TestSuite QueryBuilder
    ...
    cExpect += "WHERE KIND IN (" + CRLF
    cExpect += "    SELECT A," + CRLF
    cExpect += "           B" + CRLF
    cExpect += "    FROM C" + CRLF
    cExpect += "    WHERE D > E" + CRLF
    cExpect += "      AND F = (" + CRLF
    cExpect += "        SELECT *" + CRLF
...
Feature _22_ TestSuite QueryBuilder
    ...
    cExpect := "SELECT *" + CRLF
    cExpect += "FROM ST9990" + CRLF
    cExpect += "WHERE T9_NOMBEM LIKE '%TORNO%'" + CRLF
...
Feature _23_ TestSuite QueryBuilder
    Local oQuery
    Local cExpect

    cExpect := "SELECT (" + CRLF
    cExpect += "    SELECT *" + CRLF
    cExpect += "    FROM ANOTHER" + CRLF
    cExpect += "  )," + CRLF
    cExpect += "       (" + CRLF
    cExpect += "    SELECT *" + CRLF
    cExpect += "    FROM AND_OTHER" + CRLF
    cExpect += "  ) AS POTATO" + CRLF
    cExpect += "FROM CHAOS" + CRLF
